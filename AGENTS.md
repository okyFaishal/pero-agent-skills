...
3. `pero-user-stories/` : Translasi PRD ke Gherkin stories, domain ERD, RBAC & API contracts ➔ `docs/SystemSpec.md (atau docs/system-spec/index.md)` & `SDR-[YYYYMMDDHHmm].md` (Fixed 5-Specialist Squad + Contract Grilling Pause Gate).
...
7. `pero-task-decomposition/` : Pemecahan spesifikasi ke backlog Dual-Mode (Mode A 5-Fase Greenfield & Mode B 4-Langkah Brownfield Milestone) ➔ `docs/TaskBacklog.md (atau docs/task-backlog/index.md)` & `TDR-[YYYYMMDDHHmm].md` (Fixed 5-Specialist Squad + Backlog Grilling Pause Gate).
